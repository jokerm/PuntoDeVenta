...
public class Clientes extends WebInternalFrame {
	 ...
	 * Create the frame.
	 */
	public Clientes(DefaultTableModel modelo) {
		super( "Clientes",true, true, true, true );
		setFrameIcon(new ImageIcon(Clientes.class.getResource("/vista/recursos/client.png")));
		...
		String[] x = {"Id","Nombre","Descuento","Credito","Adeuda","Abonado"};
